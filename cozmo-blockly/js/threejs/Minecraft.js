...
CozmoBlockly.Mob = class extends CozmoBlockly.Dynamic {
...
CozmoBlockly.Zombie = class extends CozmoBlockly.Mob {
  constructor(scene) {
    super(scene, 'img/3d/zombiehd.png');
  }
}

CozmoBlockly.Spiderman = class extends CozmoBlockly.Mob {
  constructor(scene) {
...
var MinecraftChar = function(url){
    var tTexture = CozmoBlockly.loadTexture( url );
